...
class PlayerOnlineScreen extends StatefulHookConsumerWidget {
  ...
  String chapitre;
  String formation;
  PlayerOnlineScreen(this.content, this.titre, this.chapitre, this.lesson, this.formation);

  @override
  PlayerOnlineScreenState createState() => PlayerOnlineScreenState(content, titre, chapitre, lesson, formation);
}

class PlayerOnlineScreenState extends ConsumerState<PlayerOnlineScreen> {
  ...
  PlayerOnlineScreenState(this.content, this.titre, this.chapitre, this.lesson, this.formation);
