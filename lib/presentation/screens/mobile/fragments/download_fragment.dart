...
class DownloadFragment extends StatefulWidget {
  ...
  @override
  DownloadFragmentState createState() => DownloadFragmentState();
}

class DownloadFragmentState extends State<DownloadFragment> {
  ...
  Widget buttons(
    ...
    // Get a reference to the database.
      ...
      await database.rawDelete('DELETE FROM Download WHERE taskid= ? ', [taskid]);
       ...
       Navigator.push(context, MaterialPageRoute(builder: (_) => DashboardScreen(2)), );
