...
class CoursesFragment extends StatefulHookConsumerWidget {  
  
  CoursesFragment();

  @override
  CoursesFragmentState createState() => CoursesFragmentState();
}

class CoursesFragmentState extends ConsumerState<CoursesFragment> {
