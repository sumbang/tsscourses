...
class LearningScreenTab extends StatefulHookConsumerWidget {

  Formation formation;
  LearningScreenTab(this.formation);

  @override
  LearningScreenTabState createState() => new LearningScreenTabState(this.formation);
}

class LearningScreenTabState extends ConsumerState<LearningScreenTab> {

 Formation formation;
 LearningScreenTabState(this.formation);
